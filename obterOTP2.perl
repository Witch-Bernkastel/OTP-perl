...
my $conta = $ARGV[0] or die "Informe o nome da conta, execute no terminal 'perl obterOTP2.perl contaX', X é o número da sua conta\n";
...
# Copia automaticamente (CTRL+C)
Win32::Clipboard::Set($otp);
